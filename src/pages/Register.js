    ...
    <form onSubmit={formValidate}>
      <div className="w-[100%] min-h-[100vh] bg-[#6d9ac4] flex justify-center items-center">
        <div className=" bg-white w-[450px] h-[600px] m-auto rounded-lg shadow-2xl p-[30px]">
          ...
          <div className="text-2xl py-2">Register</div>
          <div className=" flex flex-col m-2">
            ...
            <input
              ...
              name=""
              id="mail"
              className="outline-none border border-1 text-[20px] text-gray-700 border-gray-300 h-[40px] rounded-lg "
            />
          </div>
          <div className=" flex flex-col m-2">
            ...
            <div className="flex w-full relative">
              <input
                ...
                name=""
                id="pass"
                className="outline-none border border-1 text-[20px] text-gray-700 border-gray-300 h-[40px] rounded-lg w-full"
              />
              {showPassword ? (
                <FaEyeSlash
            ...
            <button className="bg-[#ee5784] mt-2 h-[40px] rounded-lg text-white shadow-lg">SIGN UP</button>
          ...
          <div className="flex justify-center">Already have an Account? &nbsp;<Link to={"/login"} className="underline text-[#ee5784]">LOGIN</Link></div>
        </div>
      </div>
    </form>
  </div>
